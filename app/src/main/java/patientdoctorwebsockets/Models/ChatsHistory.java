...
public class ChatsHistory
{
    ...
    public static ChatsHistory deJson(String json_String)
    {
        ...
        try
        {
        ChatsHistory this_chat_detail = object_mapper.readValue(json_String,ChatsHistory.class); //deserialize json object into a java class
    ...
    public static ChatsHistory deJson(LinkedHashMap hashmap)
    {
