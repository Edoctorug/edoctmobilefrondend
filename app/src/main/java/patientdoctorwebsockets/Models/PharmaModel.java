...
public class PharmaModel 
{
    ...
    public static PharmaModel deJson(String json_String)
    {
        ...
        try
        {
        PharmaModel this_chat_detail = object_mapper.readValue(json_String,PharmaModel.class); //deserialize json object into a java class
    ...
    public static PharmaModel deJson(LinkedHashMap hashmap)
    {
